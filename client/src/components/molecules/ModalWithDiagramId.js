...
const ModalWithDiagramId = ({ id, closeCallback }) => {
  return (
    <Modal onClose={closeCallback} open={true}>
      ...
      <Modal.Content>
        <Modal.Description>
          <Header>Twoje zadanie jest dostępne pod adresem localhost:3000/zadania/{id}</Header>
      ...
      <Modal.Actions>
        ...
        <Button content="akceptuj" labelPosition="right" icon="checkmark" onClick={closeCallback} positive />
      </Modal.Actions>
    </Modal>
  );
};
